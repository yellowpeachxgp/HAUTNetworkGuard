...
- [运行 34252164993](https://github.com/yellowpeachxgp/HAUTNetworkGuard/actions/runs/34252164993) 对应 macOS 接口选择回归提交：Windows、macOS、OpenWrt 三项 job 全部通过；有线优先/Wi‑Fi 回退/其他接口兜底、卸载脚本隔离测试、双 Lua 安装/升级/卸载矩阵和安装资产回读门禁通过。
