...
- [运行 34245106132](https://github.com/yellowpeachxgp/HAUTNetworkGuard/actions/runs/34245106132) 对应 Windows 统一版本源提交：Windows、macOS、OpenWrt 三项 job 全部通过；Windows 原生 CMake 版本消费、OpenWrt 双 Lua 安装/升级/卸载矩阵和安装资产回读门禁通过。
