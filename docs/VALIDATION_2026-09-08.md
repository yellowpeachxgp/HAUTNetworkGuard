...
- [运行 34246940705](https://github.com/yellowpeachxgp/HAUTNetworkGuard/actions/runs/34246940705) 对应 OpenWrt 运行时版本源提交：Windows、macOS、OpenWrt 三项 job 全部通过；Windows 原生 CMake 版本消费、OpenWrt `version.lua` 安装/升级校验、双 Lua 安装/升级/卸载矩阵和安装资产回读门禁通过。
